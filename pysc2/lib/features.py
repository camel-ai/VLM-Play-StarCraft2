...
class AgentInterfaceFormat(object):
  ...
  def __init__(
    ...
    Args:
      ...
      use_raw_units: Whether to include raw unit knowledge_data in observations. This
...
def features_from_game_info(game_info, agent_interface_format=None,
  ...
  """Construct a Features object using knowledge_data extracted from game info.
  ...
  def transform_obs(self, obs):
    ...
    def full_unit_vec(u, pos_transform, is_raw=False):
      ...
      features = [
          ...
          raw_order(0),
          raw_order(1),
          # u.tag if is_raw else 0, # vlm attention method needs to activate u.tag
          u.tag,
          u.is_hallucination,
