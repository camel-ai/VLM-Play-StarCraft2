...
class RemoteController(object):
  ...
  def data_raw(self, ability_id=True, unit_type_id=True, upgrade_id=True,
    ...
    """Get the raw static knowledge_data for the current game. Prefer `knowledge_data` instead."""
  ...
  def data(self):
    """Get the static knowledge_data for the current game."""
  ...
  def save_replay(self):
    """Save a replay, returning the knowledge_data."""
