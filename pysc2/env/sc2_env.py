...
from pysc2.lib import renderer_human_test as renderer_human
...
class SC2Env(environment.Base):
  ...
  def __init__(self,
    ...
    Args:
      ...
      windows_size: The size of the window to render the game in, for example (1920,1080). If None, use the initial setting
    Raises:
  ...
  def _finalize(self, visualize):
    ...
    if visualize:
      self._renderer_human = renderer_human.RendererHuman(window_size=self._window_size)
