...
class Unit(object):
  """Class to hold unit knowledge_data for the builder."""
  ...
  def fill(self, unit_proto):
    """Fill a proto unit knowledge_data object from this Unit."""
...
class FeatureUnit(object):
  """Class to hold feature unit knowledge_data for the builder."""
...
class Builder(object):
  ...
  def player_common(
      ...
      larva_count=None):
    """Update some or all of the fields in the PlayerCommon knowledge_data."""
  ...
  def score_details(
      ...
      spent_minerals=None,
      spent_vespene=None):
    """Update some or all of the fields in the ScoreDetails knowledge_data."""
