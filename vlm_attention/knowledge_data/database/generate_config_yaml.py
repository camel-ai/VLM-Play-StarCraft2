...
def main():
    folder_path = r"D:\pythoncode\camel_opensource\vlm_attention_starcraft2-main\vlm_attention\knowledge_data\firecrawl_test\sc2_unit_info_processed"# 处理后的文件夹路径,请设置绝对地址.
    """
    Example:
